...
//Error:
//error: “Didn't find op for builtin opcs the input to modelode 'CONV_2D' version '1'” 
...
// Our model
#include "c_model__v10_3.h"
//#include "c_model_v102.h"
...
void setup() 
{
  ...
  model = tflite::GetModel(c_model__v10_3);
  //model = tflite::GetModel(c_model_v102);
