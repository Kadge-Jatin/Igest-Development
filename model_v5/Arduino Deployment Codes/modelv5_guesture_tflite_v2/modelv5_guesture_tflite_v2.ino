...
//Error faced:
//Firmware on Arduino RP2040 crashes when code is running. It is indicated by 4 slow beeps(each second) followed by 4 fast beeps(each half second)
...
// Set up logging (will report to Serial, even within TFLite functions)
  ...
  //Pulling only MicroMutableOpResolver which is speciacilaized in Fully Connected
